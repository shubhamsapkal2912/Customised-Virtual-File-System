...
void man(char *name)
{
    ...
    {
        printf("Description : Used to closed all  file \n");
...
void DisplayHelp()
{
    ...
    printf("c;lose: To close the file\n");
    printf("closeall: To close all opened files\n");
    printf("read: To Read the contents from files\n");
    printf("write: To write contents into file\n");
    printf("exit : To Terminate file system\n");
    printf("stat: To Display infrmation of file using name\n");
    printf("fstat: To Display infrmation of file using file descriptor\n");
...
int main()
{
    ...
    while(1)
    {
        ...
        else if(count==3) //jar cmmand madhe 3 astil tr
        {
            if(strcmp(command[0],"create")==0)
            {
                ret=CreateFile(command[1],atoi(command[2])); //he ksa work zla nhi kalala pn zla
                if(ret>=0)
            ...
            else if(strcmp(command[0],"read")==0)
            {
                ...
                if(ptr==NULL)
                {
                    printf("ERROR :Memory allocation failue \n");
                    continue;
                }
